...
guest_collection4 = Collection.create(title: "Gaming", user_id: guest.id)
...
source1 = Source.create(collection_id: guest_collection1.id, source_id: "ars-technica")
source2 = Source.create(collection_id: guest_collection1.id, source_id: "techcrunch")
source3 = Source.create(collection_id: guest_collection1.id, source_id: "hacker-news")
source4 = Source.create(collection_id: guest_collection2.id, source_id: "bloomberg")
...
source7 = Source.create(collection_id: guest_collection3.id, source_id: "mtv-news-uk")
source8 = Source.create(collection_id: guest_collection4.id, source_id: "ign")
source9 = Source.create(collection_id: guest_collection4.id, source_id: "polygon")
...
source13 = Source.create(collection_id: guest_collection5.id, source_id: "four-four-two")
source14 = Source.create(collection_id: guest_collection5.id, source_id: "nfl-news")
source15 = Source.create(collection_id: guest_collection6.id, source_id: "national-geographic")
